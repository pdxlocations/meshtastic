...
| :----------: | :---------------: | :------------------------------------------------------------------------: |
| `IsLicensed` |      `true`       | See [User Config - IsLicensed](/docs/configuration/device/user#is-licensed-ham) |
|  `LongName`  |  _Your CallSign_  |     See [User Config - LongName](/docs/configuration/device/user#long-name)     |
| `ShortName`  |  _Abrv CallSign_  |    See [User Config - ShortName](/docs/configuration/device/user#short-name)    |
