...
| :----------: | :---------------: | :------------------------------------------------------------------------: |
| `IsLicensed` |      `true`       | See [User Config - IsLicensed](/docs/configuration/config/user#is-licensed-ham) |
|  `LongName`  |  _Your CallSign_  |     See [User Config - LongName](/docs/configuration/config/user#long-name)     |
| `ShortName`  |  _Abrv CallSign_  |    See [User Config - ShortName](/docs/configuration/config/user#short-name)    |
