...
- [Android App](/docs/software/android/installation)
...
- [Android App](/docs/software/android/installation)
- [Web Client](https://client.meshtastic.org)
- [iOS App](/docs/software/apple/installation)
...
1. Follow the [installation](/docs/software/android/installation) and [usage](/docs/software/python/cli/usage) instructions for [Meshtastic Android](/docs/software/android/installation).
