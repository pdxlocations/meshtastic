...
Everyone contributes in a different way. Join the [Meshtastic Discord](https://discord.gg/ktMAKGBnBs) and introduce yourself. We're all very friendly. If you'd like to pitch in some code, check out the [Development](/docs/development/android) menu on the left.
...
[See our guide here](/docs/getting-started/flashing-firmware/esp32).

### How do I update the firmware to the latest version?

Updating firmware varies with hardware. See [Flashing Firmware](/docs/getting-started/flashing-firmware/esp32).
